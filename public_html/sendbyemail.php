        ...
        <div class="row justify-content-md-center">
            <div class="col-sm-12 col-lg-6 head-form lemon-milk-medium">
                ...
                if (isset($_POST['email'])) {
                    $email_to = "administrador@elquintosolmarketing.com";
                    $email_subject = "Contacto desde el sitio web";

                    // Validación de los campos del formulario
                    if (!isset($_POST['nombre']) || !isset($_POST['empresa']) || !isset($_POST['email']) || !isset($_POST['telefono']) || !isset($_POST['servicio-interes']) || !isset($_POST['presupuesto']) || !isset($_POST['ubicacion'])) {
                    ...
                    } else if ($_POST['nombre'] == "" || $_POST['empresa'] == "" || $_POST['email'] == "" || $_POST['telefono'] == "" || $_POST['servicio-interes'] == "" || $_POST['presupuesto'] == "" || $_POST['ubicacion'] == "") {
                        echo "<h1>Ocurrió un error y el formulario no ha sido enviado. </h1><br />";
                        echo "<h2>Por favor, vuelva atrás y verifique la información ingresada</h2><br />";
                    } else {
                        // Construcción del mensaje del email
                        $email_message = "Datos proporcionados por el usuario desde el sitio www.elquintosolmarketing.com:\n\n";
                        $email_message .= "Nombre: " . $_POST['nombre'] . "\n";
                        $email_message .= "Empresa: " . $_POST['empresa'] . "\n";
                        $email_message .= "Correo electrónico: " . $_POST['email'] . "\n";
                        $email_message .= "Teléfono: " . $_POST['telefono'] . "\n";
                        $email_message .= "Servicio de producción de interés: " . $_POST['servicio-interes'] . "\n";
                        $email_message .= "Presupuesto aproximado: " . $_POST['presupuesto'] . "\n";
                        $email_message .= "Ubicación: " . $_POST['ubicacion'] . "\n\n";
                        ...
                        try {
                            ...
                            $mail->isSMTP();
                            $mail->Host = 'mail.elquintosolmarketing.com';
                            $mail->SMTPAuth = true;
                            $mail->Username = 'contacto@elquintosolmarketing.com';
                            $mail->Password = 'cP2RXSKfEj'; // Cambia esto por la contraseña real
                            ...
                            echo "<h1>Ocurrió un error al enviar el correo.</h1><br />";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 redes-sociales">
                    ...
                    <a href="https://m.facebook.com/ElQuintoSolInnovacionyTalento?mibextid=DlZzXU" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/elquintosolmx?igsh=MXVxbDZzd2pwOG5mZg==" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.youtube.com/@elquintosolinnovacionytale7575" target="_blank" rel="noopener noreferrer">
